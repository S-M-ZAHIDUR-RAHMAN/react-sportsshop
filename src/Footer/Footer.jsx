    ...
    <footer className="footer mt-10 footer-center p-10 bg-pink-700 text-white">
      <aside>
        ...
        <div className="flex flex-col justify-around gap-2 rounded-lg border border-red-500 p-5 lg:rounded-full bg-slate-700 lg:flex lg:flex-row lg:justify-around lg:gap-6">
          ...
          <Link to="/addProduct"><button className="btn accent bg-yellow-400">Add Product</button></Link>
          <Link to="/myCart"><button className="btn  bg-yellow-400">My Cart</button></Link>
